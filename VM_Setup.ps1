...
# Aktiviert spezifische Firewall-Regeln statt nach DisplayGroup zu suchen
...
New-NetIPAddress -InterfaceIndex $ifIndex -IPAddress "192.168.100.222" -PrefixLength 24 -DefaultGateway "192.168.100.1"
...
# Dies erstellt eine ausführbare Datei aus dem Skript
#Invoke-ps2exe -inputFile "C:\Users\Ruffy\Documents\RuffysWorld\PowerShell\VM_Setup.ps1" -outputFile "C:\Users\Ruffy\Documents\RuffysWorld\PowerShell\VM_Setup.exe" -noConsole